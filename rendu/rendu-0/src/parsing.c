...
/*   Updated: 2023/09/15 19:41:09 by yzaoui           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	bad_parsing(void)
{
	...
	ft_printf("============================================\n");
	ft_printf("Commande:\n");
	ft_printf("\tOn peut se deplace avec les fleche ou");
	ft_printf(" clique gauche de la souris.\n");
	ft_printf("\tZOOME avec la molete de la souris ou le signe + -.\n");
	ft_printf("\tappuyer sur \"f\" pour changer de fractal.\n");
	ft_printf("\tappuyer sur \"c\"pour changer de couleur.");
	return (0);
}
